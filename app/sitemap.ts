...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: SitemapEntry[] = [
    ...
    ...dual('/tjenester/ai-seo', '/services/ai-seo', 'monthly', 0.85),
    ...dual('/bransjer', '/industries', 'monthly', 0.7),
    ...dual('/bransjer/tannlege', '/industries/dentist', 'monthly', 0.7),
    ...dual('/bransjer/eiendomsmegler', '/industries/real-estate-agent', 'monthly', 0.7),
    ...dual('/bransjer/advokat', '/industries/lawyer', 'monthly', 0.7),
    ...dual('/bransjer/restaurant', '/industries/restaurant', 'monthly', 0.7),
    ...dual('/bransjer/frisor', '/industries/hairdresser', 'monthly', 0.7),
    ...dual('/bransjer/fysioterapeut', '/industries/physiotherapist', 'monthly', 0.7),
    ...dual('/bransjer/handverker', '/industries/tradesperson', 'monthly', 0.7),
    ...dual('/bransjer/regnskapsforer', '/industries/accountant', 'monthly', 0.7),
    ...dual('/bransjer/treningssenter', '/industries/gym', 'monthly', 0.7),
    ...dual('/bransjer/bilverksted', '/industries/auto-repair-shop', 'monthly', 0.7),
    ...dual('/bransjer/veterinaer', '/industries/veterinarian', 'monthly', 0.7),
    ...dual('/bransjer/optiker', '/industries/optician', 'monthly', 0.7),
