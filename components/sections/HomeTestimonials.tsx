...
const testimonials = [
  ...
  },
  {
    ...
    role: 'Medgründer',
    company: 'h-orbit',
    service: 'App utvikling',
    initials: 'LH',
  },
  {
    quote: 'Etter at Frameflow tok over nettsiden og sosiale medier merket vi en tydelig økning i bookingforespørsler. Innholdet er konsistent og profesjonelt, og Ivan er alltid tilgjengelig når vi trenger noe.',
    name: 'Pablo G.',
    role: 'Daglig leder',
    company: 'GV Rentals',
