...
export const routing = defineRouting({
  ...
  pathnames: {
    ...
    '/bransjer': { no: '/bransjer', en: '/industries' },
    '/bransjer/tannlege': { no: '/bransjer/tannlege', en: '/industries/dentist' },
    '/bransjer/eiendomsmegler': { no: '/bransjer/eiendomsmegler', en: '/industries/real-estate-agent' },
    '/bransjer/advokat': { no: '/bransjer/advokat', en: '/industries/lawyer' },
    '/bransjer/restaurant': { no: '/bransjer/restaurant', en: '/industries/restaurant' },
    '/bransjer/frisor': { no: '/bransjer/frisor', en: '/industries/hairdresser' },
    '/bransjer/fysioterapeut': { no: '/bransjer/fysioterapeut', en: '/industries/physiotherapist' },
    '/bransjer/handverker': { no: '/bransjer/handverker', en: '/industries/tradesperson' },
    '/bransjer/regnskapsforer': { no: '/bransjer/regnskapsforer', en: '/industries/accountant' },
    '/bransjer/treningssenter': { no: '/bransjer/treningssenter', en: '/industries/gym' },
    '/bransjer/bilverksted': { no: '/bransjer/bilverksted', en: '/industries/auto-repair-shop' },
    '/bransjer/veterinaer': { no: '/bransjer/veterinaer', en: '/industries/veterinarian' },
    '/bransjer/optiker': { no: '/bransjer/optiker', en: '/industries/optician' },
