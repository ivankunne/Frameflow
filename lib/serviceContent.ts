...
export const webdesign: Record<'no' | 'en', ServiceContent> = {
  ...
  en: {
    ...
    description: 'Short answer: web design in Bergen from Frameflow starts at NOK 15,000 excl. VAT. We build fast websites in Webflow or Next.js with SEO baked in — fixed price, reply within 24 hours.',
    longDescription: 'Short answer: a professional website from Frameflow in Bergen starts at NOK 15,000 excl. VAT and typically takes 3–6 weeks. A great website is more than pretty design. It needs to load fast, rank on Google, and guide visitors towards action. At Frameflow we build websites in Webflow and Next.js with SEO, speed and conversion built in from day one — not as an afterthought. Prefer a flexible CMS you can update yourself? We build in Webflow. Need something fully custom and lightning fast? We use Next.js. Either way you get a site built to be found in Bergen and turn visitors into customers.',
    includes: [
...
export const seo: Record<'no' | 'en', ServiceContent> = {
  no: {
    ...
    description: 'Kort svar: lokal SEO i Bergen fra Frameflow starter fra 4 500 kr/mnd eks. mva., uten bindingstid. Vi hjelper deg til side 1 med teknisk SEO, Google Business Profile og innhold som rangerer.',
    longDescription: 'Kort svar: SEO fra Frameflow i Bergen koster fra 4 500 kr/mnd, og de fleste ser målbare resultater innen 3–6 måneder. SEO er ikke en engangsoppgave – det er et kontinuerlig arbeid som bygger synlighet over tid. Vi starter med teknisk revisjon, kartlegger søkeordene kundene dine bruker, og lager innhold som treffer dem. Vi spesialiserer oss på lokal SEO for Bergen og Vestland, der du har størst sjanse til å slå konkurrentene raskt.',
    includes: [
  ...
  en: {
    ...
    description: 'Short answer: local SEO in Bergen from Frameflow starts at NOK 4,500/mo excl. VAT, with no lock-in. We help you reach page 1 with technical SEO, Google Business Profile and content that ranks.',
    longDescription: 'Short answer: SEO from Frameflow in Bergen starts at NOK 4,500/mo, and most clients see measurable results within 3–6 months. SEO is not a one-time task — it is continuous work that builds visibility over time. We start with a technical audit, map the keywords your customers use, and create content that reaches them. We specialise in local SEO for Bergen and Vestland, where you have the best chance of beating competitors quickly.',
    includes: [
...
export const markedsforing: Record<'no' | 'en', ServiceContent> = {
  no: {
    ...
    description: 'Kort svar: Frameflow er markedsføringsbyrå i Bergen fra 4 500 kr/mnd for løpende SEO eller sosiale medier. Webdesign, SEO, sosiale medier og branding under ett tak – du snakker alltid direkte med Ivan.',
    longDescription: 'Kort svar: et markedsføringsbyrå i Bergen hos Frameflow betyr én kontaktperson, fast pris og tjenester fra 4 500 kr/mnd (løpende) eller fra 15 000 kr for nettside. Digital markedsføring er ikke ett fag – det er mange disipliner som henger sammen. En god nettside uten SEO blir usynlig. En sterk merkevare uten konsistent innhold mister troverdighet.\n\nHos Frameflow leverer vi helhetlig digital markedsføring for Bergen- og Vestland-bedrifter – der kanalene jobber mot ett mål: flere kunder. Du snakker alltid direkte med Ivan, personen som faktisk designer, skriver og leverer.\n\nIngen bindingstid på løpende tjenester. Fast pris på prosjekter. Fornøyd garanti på alt vi leverer.',
    includes: [
  ...
  en: {
    ...
    description: 'Short answer: Frameflow is a marketing agency in Bergen from NOK 4,500/mo for ongoing SEO or social media. Web design, SEO, social and branding under one roof — you always talk directly with Ivan.',
    longDescription: 'Short answer: a marketing agency engagement with Frameflow in Bergen means one contact, fixed pricing, and services from NOK 4,500/mo (retainers) or from NOK 15,000 for a website. Digital marketing is not one discipline — it is many that work together. A great website without SEO becomes invisible. A strong brand without consistent content loses credibility.\n\nAt Frameflow we deliver holistic digital marketing for Bergen and Vestland businesses — channels working toward one goal: more customers. You always speak directly with Ivan, the person who designs, writes and delivers.\n\nNo lock-in on ongoing services. Fixed price on projects. Satisfaction guarantee on everything we deliver.',
    includes: [
