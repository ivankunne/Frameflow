...
export const projects: Project[] = [
  ...
  },
  {
    ...
    seo: {
      titleNo: 'Sportsbytte – webdesign og branding | Frameflow',
      titleEn: 'Sportsbytte – web design and branding | Frameflow',
      descNo: 'Ny nettside og visuell identitet for Sportsbytte, plattformen for brukt sportsutstyr. Case fra Frameflow i Bergen.',
      descEn: 'New website and visual identity for Sportsbytte, Norway’s used sports marketplace. A Frameflow case from Bergen.',
  ...
  },
  {
    ...
    seo: {
      titleNo: 'Betlehem – Webflow-vedlikehold og SEO | Frameflow',
      titleEn: 'Betlehem – Webflow maintenance and SEO | Frameflow',
      descNo: 'Løpende Webflow-vedlikehold og SEO for Betlehem / Bergens Indremisjon. Levert av Frameflow i Bergen.',
      descEn: 'Ongoing Webflow maintenance and SEO for Betlehem / Bergens Indremisjon. Delivered by Frameflow in Bergen.',
